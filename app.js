...
const C = { animals: [], matings: [], pregnancies: [], births: [], vaccineTypes: [], vaccinations: [], treatments: [], treatmentTypes: [], members: [], backups: [], types: [], tips: [], expenses: [], forumCats: [], forumMods: [], forumBans: [] };
// جداول الحلال المعزولة بالمالك — تُحفظ نسخة خام في C._<key> ويُعرض في التطبيق حلالي فقط
const HERD_KEYS = ['animals', 'matings', 'pregnancies', 'births', 'vaccinations', 'treatments', 'expenses'];
const TABLES = {
...
function monthIdxOf(d) { if (!d) return null; const x = new Date(d + 'T00:00:00'); return x.getFullYear() * 12 + x.getMonth(); }
